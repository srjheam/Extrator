...
def test_ranking_separa_fontes_e_docente_nao_repete_vinculo(tmp_path):
    ...
    repo.salvar_metricas([
        ...
        {"snapshot_id": snapshot, "publicacao_canonica_id": "c2", "provedor": "openalex", "nome_metrica": "openalex.cited_by_count", "valor": 10, "unidade": "citacoes", "periodo_inicio": "", "periodo_fim": "", "categoria": "", "papel_provedor": "FALLBACK", "fallback_acionado_por": "google_scholar:NAO_ENCONTRADO"},
    ])
    ocorrencias = [
    ...
    assert {x["ranking_na_fonte"] for x in ranking} == {"1"}
